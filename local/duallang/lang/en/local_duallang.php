...
$string['secondarylang_desc'] = 'Not the user\'s native language but,
typically, the language used in their locale';
$string['readingorder']      = 'Reading order';
$string['readingorder_desc'] = 'The reading order setting specifies whether
the primary language is displayed to the left or the right of the secondary
language';
